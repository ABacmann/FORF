...
def process_images(src_images, indir, outdir, config):
    ...
    for infile in src_images:
        try:
            ...
            print(f"Generated {len(src_masks)} masks")
            ...
            print(f"Filtered masks to {len(filtered_image_mask_pairs)} pairs")
            ...
            print(f"Saved masks and images for {infile}")
...
def main(args):
    ...
    print(f"Found {len(in_files)} image files to process.")
