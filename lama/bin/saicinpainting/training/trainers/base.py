...
class BaseInpaintingTrainingModule(ptl.LightningModule):
    ...
    def training_step(self, batch, batch_idx, optimizer_idx=None):
        ...
        return self._do_step(batch, batch_idx, mode='val_source', optimizer_idx=optimizer_idx)
    ...
    def _do_step(self, batch, batch_idx, mode='val_source', optimizer_idx=None, extra_val_key=None):
